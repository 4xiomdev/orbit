//
//  OrbitScreenCaptureUtility.swift
//  Orbit
//
//  Standalone screenshot capture for Orbit's voice-and-screen flow.
//  Decoupled from the old screenshot manager so Orbit can capture the
...
enum OrbitScreenCaptureUtility {
    ...
    static func captureAllScreensAsJPEG() async throws -> [OrbitScreenCapture] {
