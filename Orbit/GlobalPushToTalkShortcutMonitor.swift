...
//  Orbit
//
//  Captures push-to-talk keyboard shortcuts while Orbit is running in the
...
final class GlobalPushToTalkShortcutMonitor: ObservableObject {
    let shortcutTransitionPublisher = PassthroughSubject<OrbitPushToTalkShortcut.ShortcutTransition, Never>()
    ...
    private func handleGlobalEventTap(
        ...
        let shortcutTransition = OrbitPushToTalkShortcut.shortcutTransition(
            for: eventType,
