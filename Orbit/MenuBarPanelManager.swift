...
//  (OrbitPanelView) via NSHostingView. Uses the same NSPanel pattern as
...
final class MenuBarPanelManager: NSObject {
    ...
    private func createStatusItem() {
        ...
        button.image = OrbitBranding.makeTemplateMenuBarIcon(size: 18)
    ...
    private func createPanel() {
        let orbitPanelView = OrbitPanelView(orbitManager: orbitManager)
            .frame(width: panelWidth)

        let hostingView = NSHostingView(rootView: orbitPanelView)
