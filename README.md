...
<p align="center">
  <img src="docs/assets/orbit-banner.png" alt="Orbit running on macOS" />
</p>

<p align="center">
  <img src="docs/assets/orbit-panel.png" alt="Orbit menu bar panel" width="320" />
</p>
...
2. If you already use Codex, Orbit can reuse your existing ChatGPT-backed Codex session automatically.
3. If no shared Codex auth is available, Orbit opens the managed ChatGPT browser flow for you.
...
- Codex auth reuses the normal shared Codex home at `~/.codex` when available.
